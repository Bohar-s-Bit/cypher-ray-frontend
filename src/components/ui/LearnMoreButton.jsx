...
const LearnMoreButton = ({ onClick, text = "Learn More" }) => {
  return (
    <StyledWrapper>
...
const StyledWrapper = styled.div`
  .button {
    ...
    gap: 10px;
    font-size: 14px;
    background-image: linear-gradient(#7808d0, #4a0582);
    color: white;
    border: solid 2px #2d1b47;
    height: 50px;
    padding: 0px 20px;
    border-radius: 5px;
    font-weight: 600;
  ...
  .button:active {
    background-image: linear-gradient(#4a0582, #7808d0);
    border-color: #4a0582;
  }
  .icon {
    position: relative;
