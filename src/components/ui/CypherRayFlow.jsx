      ...
      */}
      <div className="absolute top-[8%] w-full h-full max-w-[85%] mx-auto pointer-events-none">
        ...
        */}
        <TopBadge
          icon={Brain}
          text={badgeTexts?.first || "CypherLLM"}
          leftPosition="15%"
        />
        <TopBadge
          icon={Bot}
          text={badgeTexts?.second || "Model 1"}
          leftPosition="38%"
        />
        <TopBadge
          icon={Cpu}
          text={badgeTexts?.third || "Model 2"}
          leftPosition="62%"
        />
        <TopBadge
          icon={Terminal}
          text={badgeTexts?.fourth || "SDK"}
          leftPosition="85%"
        />
      </div>
      ...
      */}
      ...
      >
        ...
        <defs>
          <mask id="db-mask-1">
            <path
              d="M 30 10 v 15 q 0 5 5 5 h 58 q 5 0 5 5 v 45"
              strokeWidth="0.5"
              stroke="white"
            />
          </mask>
          <mask id="db-mask-2">
            <path
              d="M 76 10 v 10 q 0 5 5 5 h 12 q 5 0 5 5 v 45"
              strokeWidth="0.5"
              stroke="white"
            />
          </mask>
          <mask id="db-mask-3">
            <path
              d="M 124 10 v 10 q 0 5 -5 5 h -14 q -5 0 -5 5 v 45"
              strokeWidth="0.5"
              stroke="white"
            />
          </mask>
          <mask id="db-mask-4">
            <path
              d="M 170 10 v 15 q 0 5 -5 5 h -60 q -5 0 -5 5 v 45"
              strokeWidth="0.5"
              stroke="white"
            />
          </mask>
      ...
      */}
      <div className="relative flex w-full flex-col items-center z-20">
        ...
        <div className="absolute -top-3 z-20 flex items-center justify-center rounded-lg border border-purple-500/20 bg-gray-950 px-3 py-1.5 shadow-xl">
          ...
          <span className="ml-2 text-[20px] font-large text-gray-200">
            {title ? title : "Firmware Binary Analysis"}
          </span>
        </div>

        {/* Box Outer Circle */}
        <div className="absolute -bottom-8 z-30 grid h-[80px] w-[80px] place-items-center rounded-full border-t border-purple-500/30 bg-gray-900 shadow-xl overflow-hidden">
          <img
            src="../../../public/images/Cypher-ray_NOBG.png"
            alt="CypherRay Logo"
        ...
        <div className="relative z-10 flex h-[220px] w-full items-center justify-center overflow-hidden rounded-xl border border-purple-500/20 bg-gray-950/80 backdrop-blur-sm shadow-2xl">
          ...
          <div className="absolute bottom-[15%] left-[15%] z-10 h-7 rounded-full bg-purple-900/20 px-3 text-xs border border-purple-500/30 flex items-center gap-2">
            ...
            <span className="text-purple-200 font-medium whitespace-nowrap">
              {buttonTexts?.first || "Encryption"}
            </span>
          </div>
          ...
          <div className="absolute bottom-[15%] right-[15%] z-10 hidden sm:flex h-7 rounded-full bg-purple-900/20 px-3 text-xs border border-purple-500/30 items-center gap-2">
            ...
            <span className="text-purple-200 font-medium whitespace-nowrap">
              {buttonTexts?.second || "Cryptography"}
            </span>
          </div>
