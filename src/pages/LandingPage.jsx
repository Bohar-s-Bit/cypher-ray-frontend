...
const Terminal = lazy(() =>
  import("../components/ui/Terminal").then((module) => ({
    default: module.Terminal,
  }))
);
const TypingAnimation = lazy(() =>
  import("../components/ui/Terminal").then((module) => ({
    default: module.TypingAnimation,
  }))
);
const AnimatedSpan = lazy(() =>
  import("../components/ui/Terminal").then((module) => ({
    default: module.AnimatedSpan,
  }))
);
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center justify-center">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, #060010 0%, rgba(10, 0, 21, 0.6) 60%, transparent 100%)",
          }}
        ></div>
      ...
      {/* Features Section */}
      <section
        className="py-20 bg-transparent -mt-12 pt-20"
        style={{
          background:
            "linear-gradient(135deg, #060010 0%, #0a0015 50%, #060010 100%)",
        }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
              Integrate Cypher-Ray's powerful security analysis directly into
              ...
              <Terminal className="bg-neutral-900 border-neutral-700 max-w-5xl w-full h-[500px]">
                <AnimatedSpan delay={0}>
                  <span className="text-green-400">
                    ...
                    <span className="text-white"> npm run scan</span>
                  </span>
                </AnimatedSpan>
                <TypingAnimation className="text-purple-400 font-bold">
                  🔍 CypherRay SDK - Firmware Security Scanner
                </TypingAnimation>
                ...
                <AnimatedSpan className="text-neutral-500 text-sm">
                  [SDK Debug] API URL:
                  https://cypher-ray-backend.onrender.com/api/sdk
                </AnimatedSpan>
                <AnimatedSpan className="text-neutral-500 text-sm">
                ...
                <AnimatedSpan className="text-neutral-400">&nbsp;</AnimatedSpan>
                <AnimatedSpan className="text-neutral-500">
                  ⠋ Saving JSON report...✓ Report saved to:
                  cypherray-report.json
                </AnimatedSpan>
                <AnimatedSpan className="text-green-500">
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-4 lg:py-6">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul className="text-neutral-300 font-medium">
                  <li className="mb-4">
                    <a
                      href="https://github.com/cypher-ray"
                      className="hover:underline hover:text-purple-400"
                    >
                      Github
                    </a>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a
                href="#"
                className="text-neutral-300 hover:text-purple-400 ms-5"
              >
                <svg
                  className="w-5 h-5"
                  aria-hidden="true"
