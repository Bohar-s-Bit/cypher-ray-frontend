          ...
          >
            ...
            <span
              className={cn(
                ...
                value === index && "text-purple-400 opacity-100 font-bold text-lg"
              )}
            >
              {loadingState.text}
            </span>
...
export const MultiStepLoader = ({
  ...
  // If currentStep is provided, use it directly
  useEffect(() => {
  ...
  }, [currentStep, currentState, loading, loop, loadingStates.length, duration]);
    ...
    <AnimatePresence mode="wait">
      {loading && (
        <motion.div
          ...
          className="w-full h-full fixed inset-0 z-[100] flex items-center justify-center backdrop-blur-md bg-black/60"
        >
